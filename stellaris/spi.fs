...
\ (c) 2013 by Gerald Wodni <gerald.wodni@gmail.com>
...
: init-ssi-2 ( )
    ...
    8 2 init-ssi                ( Initialize SSI2 with 8 data bits as master )
    0 1 2 ssi-speed          ( Slow Speed )
